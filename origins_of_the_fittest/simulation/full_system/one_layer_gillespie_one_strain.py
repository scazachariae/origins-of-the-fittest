...
def simulation_fittest_only_phylogeny(
    ...
    This behavior is closer to the approximation methods and can be used to analyze the imnpact
    of this assumption on the results.
